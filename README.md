...
### Lab 3 (Environment 1) - Data Exploration and Transformation in Azure Databricks
...
### Lab 4 (Environment 3) - Run interactive queries using Azure Synapse Analytics serverless SQL pools
...
### Lab 5 (Environment 3) - Explore, transform, and load data into the Data Warehouse using Apache Spark
...
### Lab 6 (Environment 3) - Ingest and load data into the data warehouse
...
### Lab 7 (Environment 3) - Transform data with Azure Data Factory or Azure Synapse Pipelines
...
### Lab 8 (Environment 3) - Integrate data from Notebooks with Azure Data Factory or Azure Synapse Pipelines
...
### (optional) Bonus Lab (Environment 3) - Build reports using Power BI integration with Azure Synapse Analytics
